...
class WaterRemoteDataSource {
  ...
  Future<List<WaterEntryModel>> getWaterLogs(DateTime date) async {
    try {
      ...
      AppLogger.error('WaterRemoteDataSource.getWaterLogs', e);
      rethrow;
    }
  }
  ...
  Future<WaterEntryModel> addWaterLog({
    ...
    try {
      ...
      AppLogger.error('WaterRemoteDataSource.addWaterLog', e);
      rethrow;
    }
  }
  ...
  Future<void> deleteWaterLog(String id) async {
    try {
      ...
      AppLogger.error('WaterRemoteDataSource.deleteWaterLog', e);
      rethrow;
    }
  }
  ...
  Future<int> getWaterGoal() async {
    try {
      ...
      AppLogger.error('WaterRemoteDataSource.getWaterGoal', e);
      rethrow;
    }
  }
}
